...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (email, password) {
        ...
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiClint + "professionals/login", { email: email, password: password }, options)
...
/* harmony import */ var _contact__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./contact */ "./src/app/contact/index.ts");
/* harmony import */ var _profile__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./profile */ "./src/app/profile/index.ts");
/* harmony import */ var _setting__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./setting */ "./src/app/setting/index.ts");
/* harmony import */ var _inbox__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./inbox */ "./src/app/inbox/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _inbox__WEBPACK_IMPORTED_MODULE_20__["InboxComponent"],
                _contact__WEBPACK_IMPORTED_MODULE_17__["ContactComponent"],
                _profile__WEBPACK_IMPORTED_MODULE_18__["ProfileComponent"],
                _setting__WEBPACK_IMPORTED_MODULE_19__["SettingComponent"],
...
/* harmony import */ var _contact__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./contact */ "./src/app/contact/index.ts");
/* harmony import */ var _profile__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./profile */ "./src/app/profile/index.ts");
/* harmony import */ var _setting__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./setting */ "./src/app/setting/index.ts");
...
var appRoutes = [
    { path: '', component: _home__WEBPACK_IMPORTED_MODULE_1__["HomeComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    ...
    { path: 'blank', component: _blank__WEBPACK_IMPORTED_MODULE_4__["BlankComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'project', component: _project__WEBPACK_IMPORTED_MODULE_5__["ProjectComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'dashboard', component: _dashboard__WEBPACK_IMPORTED_MODULE_6__["DashboardComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'message', component: _message__WEBPACK_IMPORTED_MODULE_7__["MessageComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'inbox', component: _inbox__WEBPACK_IMPORTED_MODULE_8__["InboxComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'contact', component: _contact__WEBPACK_IMPORTED_MODULE_9__["ContactComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'profile', component: _profile__WEBPACK_IMPORTED_MODULE_10__["ProfileComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'setting', component: _setting__WEBPACK_IMPORTED_MODULE_11__["SettingComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
...
var ContactComponent = /** @class */ (function () {
    function ContactComponent(userService, formBuilder) {
        this.userService = userService;
        this.formBuilder = formBuilder;
        this.users = [];
        this.isUserLogin = false;
    ...
    ContactComponent.prototype.deleteUser = function (id) {
        var _this = this;
        this.userService.delete(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function () {
            _this.loadAllUsers();
        });
    };
    ContactComponent.prototype.loadAllUsers = function () {
        var _this = this;
        this.userService.getAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (users) {
            _this.users = users;
        });
    };
    ContactComponent.prototype.onSearch = function () {
        this.submitted = true;
        alert(1);
    };
    ContactComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({ template: __webpack_require__(/*! ./contact.component.html */ "./src/app/contact/contact.component.html") }),
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(userService, formBuilder) {
        this.userService = userService;
        this.formBuilder = formBuilder;
        this.users = [];
        this.isUserLogin = false;
    ...
    ProfileComponent.prototype.onSearch = function () {
        this.submitted = true;
        alert(1);
    };
    ProfileComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({ template: __webpack_require__(/*! ./profile.component.html */ "./src/app/profile/profile.component.html") }),
        __metadata("design:paramtypes", [_services__WEBPACK_IMPORTED_MODULE_3__["UserService"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]])
    ], ProfileComponent);
...
var ProjectComponent = /** @class */ (function () {
    ...
    ProjectComponent.prototype.onSubmit1 = function () {
        //this.submitted = true;
        this.isFormNumber = 2;
    };
    ProjectComponent.prototype.onSubmit2 = function () {
        //this.submitted = true;
        this.isFormNumber = 3;
    };
    ProjectComponent.prototype.onSubmit3 = function () {
        //this.submitted = true;
        this.isFormNumber = 1;
    };
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SettingComponent", function() { return _setting_component__WEBPACK_IMPORTED_MODULE_0__["SettingComponent"]; });
...
var SettingComponent = /** @class */ (function () {
    function SettingComponent(userService, formBuilder) {
        this.userService = userService;
        this.formBuilder = formBuilder;
        this.users = [];
        this.isUserLogin = false;
    ...
    SettingComponent.prototype.deleteUser = function (id) {
        var _this = this;
        this.userService.delete(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function () {
            _this.loadAllUsers();
        });
    };
    SettingComponent.prototype.loadAllUsers = function () {
        var _this = this;
        this.userService.getAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (users) {
            _this.users = users;
        });
    };
    SettingComponent.prototype.onSearch = function () {
        this.submitted = true;
        alert(1);
    };
    SettingComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({ template: __webpack_require__(/*! ./setting.component.html */ "./src/app/setting/setting.component.html") }),
        __metadata("design:paramtypes", [_services__WEBPACK_IMPORTED_MODULE_3__["UserService"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]])
    ], SettingComponent);
...
var environment = {
    ...
    apiClint: "https://apibrnormas.herokuapp.com/",
};
/*
...
module.exports = __webpack_require__(/*! E:\Angular6\angular6\src\main.ts */"./src/main.ts");
